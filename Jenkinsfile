  ...
  withMaven(jdk: 'java1.8', maven: 'Maven3.6.0') {
	...
	stage('SonarQube Analysis'){
		...
		withSonarQubeEnv('sonar-server'){
			...
			sh  "mvn clean package sonar:sonar -Dsonar.projectName=JpetStore-velocity -Dsonar.host.url=http://ec2-3-130-60-241.us-east-2.compute.amazonaws.com:50000 sonarqube"
